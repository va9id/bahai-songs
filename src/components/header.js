                ...
                <div class="collapse navbar-collapse order-2 order-sm-1" id="navbarNav">
                    <ul class="navbar-nav">
                        <li class="nav-item">
							...
							}" href="${basePath}index.html">Home</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link ${
								currentPage === "songs.html" ||
								currentPage == "song.html"
									? "active"
									: ""
							}" href = "${basePath}src/pages/songs.html">Songs</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link ${
	...
	function performSearch() {
		...
		if (results.length > 0) {
			...
			searchResults.innerHTML =
				'<div class="search-no-result -p-2">No results found</div>';
			searchResults.style.display = "block";
		}
	}
